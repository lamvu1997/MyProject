<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HandleAddClass.aspx.cs" Inherits="HandleAddClass" %>
        ...
        <div style="margin-top: 15%;display:flex">
            ...
            <div style="width: 65%; margin-left: 10%">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="Label11" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label></td>
                    </tr>
                    <tr>
                        <td>
