<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HandleChangeclass.aspx.cs" Inherits="HandleChangeclass" %>
        ...
        <div style="margin-top: 15%; display: flex">
            ...
            <div style="width: 65%; margin-left: 10%">
                <table>
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="Label7" runat="server" ForeColor="Lime" Text="Saved change successfully" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="From" Visible="False"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label12" runat="server" Text="To" Visible="False"></asp:Label></td>
