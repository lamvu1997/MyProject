<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnnouncementForStudent.aspx.cs" Inherits="AnnouncementForStudent" %>
    ...
    <form id="form1" runat="server">
            ...
            <div style="width:15%;">
                ...
                <div style="width:70%;text-align:center">
                    <asp:Label ID="Label1" runat="server" ForeColor="#FF3300" Text="Your message box is empty"></asp:Label>
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="Message has been deleted" Visible="False"></asp:Label>
                   <br />
                    <asp:TextBox ID="TextBox1" runat="server" Height="92px" TextMode="MultiLine" Visible="False" Width="227px"></asp:TextBox>
                    <br />
